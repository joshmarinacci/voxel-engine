...
const voxelMesh = require('voxel-mesh')
const ray = require('./raycast')
...
// Game.prototype.raycast = // backwards compat
  raycast(start,direction,maxDistance,epislon) {
    return this.raycastVoxels(start,direction,maxDistance,epislon)
  }
